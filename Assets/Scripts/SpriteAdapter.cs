...
namespace Tools
{
    ...
    {
        private static SpriteAdapter _instance;
        public static SpriteAdapter Instance
        {
            get
            {
                if (_instance == null)
                    //则创建一个
                    _instance = GameObject.Find("Main Camera").GetComponent<SpriteAdapter>();
                //返回这个实例
                return _instance;
            }
        }
